...
<h1 align="center" styel="width:50%"> 💻 Front-End Developer | 🎨 UI/UX Designer | 🚀 Aspiring Full Stack Developer</h1>
...
| 🌐 **Webrift Technologies** | Webrift Technologies — Webrift is the official company website developed as a team project, showcasing the organization’s services, brand identity, and digital presence with a clean, responsive, and user-friendly design. | 🔗 [View Project](http://webrifttechnology.vercel.app) |
<br>
<hr style="height: 2.5px; background-color: #666; border: none; width: 80%; margin: auto;">
